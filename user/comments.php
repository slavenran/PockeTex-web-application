            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        if (response[i].username === response[i].session_username) {
                            comments += "<td style='text-align: left; width: 60%;'><textarea class='form-control' style='margin-top: 20px' id='"
                                ...
                                "</textarea><a href='editcomment.php?id=" + response[i].id + "'><input type='button' class='buttonz' value='Edit' name='edit'/></a></td>";
                        } else {
                            comments += "<td style='text-align: center'><p style='margin-top: 20px; color: #d1e8e2;'>" + response[i].text + "</p></td>";
                        }
                        comments += "</tr>";
                    }
                    comments += "</table>";
