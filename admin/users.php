            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(var i = 0; i < response.length; i++) {
                        htmlString += "<tr>";
                        htmlString += "<td style='text-align: center'>" + response[i].username + "</td>";
                        htmlString += "<td style='text-align: center'>" + response[i].email + "</td>";
                        htmlString += "<td style='text-align: center'><a href='http://localhost/php/HALPv2/api/users/delete_user.php?id=" + response[i].id + "'><input type='button' class='buttonz' value='Delete'/></a></td>";
                        htmlString += "</tr>";
                    }
                    htmlString += "</table>";
